...
then i went on to make this game called DONT GET CAUGHT where u can run away from your own mouse tryna catch you add if you get caught well then game over and theres some dash button and maybe ill add invisabilty potion and im yet to add sprites.
then theirs a two player mode i wanted so you can play with person beside you where you both control a charachter running away its more open world to a limit and one player has master control and basically theres a split button that splits the cursor in too to try trap yoour oponent and some other stuff to js make it competitive.
sorry this readme is real long but i just need to make sure im clear and get qualified to go to austria!(i told way to many people to motivate myself to finish 50 hours)
