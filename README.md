...
the space bar is dash.
hit the invis potion and become invisable and the mouse runs around disorientated.
catch the midnight bird and in endless mode gain back your strength or in adevnture travel to a new web page with different challenges.

simple build or deploy instructions.
